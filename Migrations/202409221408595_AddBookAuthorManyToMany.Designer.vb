...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddBookAuthorManyToMany
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddBookAuthorManyToMany))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202409221408595_AddBookAuthorManyToMany"
            End Get
        End Property
