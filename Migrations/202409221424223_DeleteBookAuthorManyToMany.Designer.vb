...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DeleteBookAuthorManyToMany
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DeleteBookAuthorManyToMany))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202409221424223_DeleteBookAuthorManyToMany"
            End Get
        End Property
