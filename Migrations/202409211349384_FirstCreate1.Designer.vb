...
Namespace Migrations
    ...
    Public NotInheritable Partial Class FirstCreate1
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(FirstCreate1))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202409211349384_FirstCreate1"
            End Get
        End Property
